...
(function () {
    ...
    const BLOCKED_COMPANIES = [
        ...
        /\binfosys\b/i,
        /\bShell\b/i,
        /\bTata Technologies\b/i,
        /\bTata Technologies Limited\b/i,
        /\bTata Technologies Ltd\b/i,
        /\bGE Vernova\b/i,
        /\bTELUS Digital\b/i,
        /\bCargill\b/i,
        /\bcgi\b/i,
    ...
    const BLOCKED_JOB_TITLES = [
        ...
        /(?:^|[^a-z0-9])Emulation Prototyping Engineer(?:$|[^a-z0-9])/i,
        ...
        /(?:^|[^a-z0-9])Medical Software(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])CMS Developer(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])BALA(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Rave(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Customer(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Custom(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Function(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Developer II(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])C\+\+(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Developer(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Advocate(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Custom(?:$|[^a-z0-9])/i,
        ...
        /(?:^|[^a-z0-9])SDET(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Web Developer(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Signal Processing(?:$|[^a-z0-9])/i,
        ...
        /(?:^|[^a-z0-9])SNOW(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Digital(?:$|[^a-z0-9])/i,
        ...
        /(?:^|[^a-z0-9])Monitoring(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Diagnostics(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Materials(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Analyst(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Assembly(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Firmware Engineer(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Prompt Engineer(?:$|[^a-z0-9])/i,
        ...
        /(?:^|[^a-z0-9])PowerCurve Developer(?:$|[^a-z0-9])/i,
        /(?:^|[^a-z0-9])Codex(?:$|[^a-z0-9])/i,
